classdef Pc3D_Hall_UnitTest < matlab.unittest.TestCase
%% Series of Tests intended to test the 2D probability of Collision Calculation at TCA
    ...
    methods (Test)
        function test01(testCase) % Alfano Test Case 1
            % Errors due to existence at Equinoctial frame singularity
            % (Perfect retrograde orbit)
            HBR             = 15;
...
%             testCase.verifyEqual(actSolution,expSolution,'RelTol',Accuracy);
            ...
            testCase.verifyError(@()Pc3D_Hall(r1_J2K*1000,v1_J2K*1000,C1_J2K,r2_J2K*1000,v2_J2K*1000,C2_J2K,HBR),...
...
%             testCase.verifyEqual(actSolution,expSolution,'RelTol',Accuracy);
        ...
        function test07(testCase) % Alfano Test Case 7
            ...
            expNcResult     = 0.000161462; % Alfano 1E9 MC trials
        ...
        function test08(testCase) % Alfano Test Case 8
            HBR             = 4;
            Accuracy        = 0.001; % Desired MC Accuracy (0.01=1%)
            expSolution     = 0.035256080; % 1E8 Monte Carlo Result
            % ID of Test Event
        ...
        function test10(testCase) % Alfano Test Case 10
            HBR             = 6;
            Accuracy        = 0.01; % Desired MC Accuracy (0.01=1%)
            expSolution     = 0.362952470; % 1E8 Monte Carlo Result
            % ID of Test Event
...
%         end
        function test12(testCase) % Original Test Omitron Test Case 01 (Written by Dragan Plakalovic) 
            % Errors due to position only components in covariance
            % Circular Area
...
%             testCase.verifyTrue(IsRemediated);
        ...
        function test14(testCase) % Operational Case where 3D Pc is ~15 orders of magnitude larger than 2D estimation
            HBR             = 20;
            Accuracy        = 0.001; % Desired MC Accuracy (0.01=1%)
            exp2DSolution   = 2.2660816e-20;
            exp3DSolution   = 1.9271201e-05;
            % ID of Test Event
            FileName = 'OmitronTestCase_Test08_3DNc.cdm';
