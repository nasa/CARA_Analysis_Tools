...
%% Series of Tests intended to test the Determination of TCA rectification from if improperly characterized in state estimates
    methods (Test)
        function test01(testCase) % Max PC
            ...
            % Change default params for separate cov scaling
            params = [];
            params.PriSecScaling = 'separate';
            
            % Calculate Dilution Region Maximum PC
            [actDilutionMaxPc,Diluted,~,~] = DilutionMaxPc(r1_J2K*1000,v1_J2K*1000,C1_J2K,r2_J2K*1000,v2_J2K*1000,C2_J2K,HBR);
            ...
            [~,Diluted,~,~] = DilutionMaxPc(r1_J2K*1000,v1_J2K*1000,C1_J2K/1000,r2_J2K*1000,v2_J2K*1000,C2_J2K,HBR,params);
            testCase.verifyEqual(Diluted,1,'RelTol',Accuracy);
            
            % Test For Only Primary Dilution
            [~,Diluted,~,~] = DilutionMaxPc(r1_J2K*1000,v1_J2K*1000,C1_J2K,r2_J2K*1000,v2_J2K*1000,C2_J2K/1000000,HBR,params);
            testCase.verifyEqual(Diluted,10,'RelTol',Accuracy);
            
            % Test For Only Neither Object in Dilution Region
            [~,Diluted,~,~] = DilutionMaxPc(r1_J2K*1000,v1_J2K*1000,C1_J2K/1000,r2_J2K*1000,v2_J2K*1000,C2_J2K/1000000,HBR);
