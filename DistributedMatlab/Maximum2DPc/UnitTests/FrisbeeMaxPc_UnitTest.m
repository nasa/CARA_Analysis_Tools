classdef (SharedTestFixtures = { ...
        ...
        FrisbeeMaxPc_UnitTest < matlab.unittest.TestCase
...
% ----------------- BEGIN CODE -----------------
    ...
    methods (Test)
        function test01(testCase) % Alfano Test Case 1
            ...
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/AlfanoTestCase01.cdm';
           ...
           % Set up Primary Object State and Covariance
            ...
            actSolution = FrisbeeMaxPc(r1_J2K*1000,v1_J2K*1000,C1_J2K,r2_J2K*1000,v2_J2K*1000,C2_J2K,HBR);    
        ...
        function test02(testCase) % Alfano Test Case 2
            ...
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/AlfanoTestCase02.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test03(testCase) % Alfano Test Case 3
            ...
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/AlfanoTestCase03.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test04(testCase) % Alfano Test Case 4
            ...
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/AlfanoTestCase04.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test05(testCase) % Alfano Test Case 5
            ...
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/AlfanoTestCase05.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test06(testCase) % Alfano Test Case 6
            ...
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/AlfanoTestCase06.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test07(testCase) % Alfano Test Case 7
            ...
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/AlfanoTestCase07.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test08(testCase) % Alfano Test Case 8
            ...
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/AlfanoTestCase08.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test09(testCase) % Alfano Test Case 9
            ...
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/AlfanoTestCase09.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test10(testCase) % Alfano Test Case 10
            ...
            expSolution     = 0.290146291;
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/AlfanoTestCase10.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test11(testCase) % Alfano Test Case 11
            ...
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/AlfanoTestCase11.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test12(testCase) % Manufactured Test Case Corresponding To Frisbee's Example (HBR=5)
            ...
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/FrisbeeMaxPcTestCase_Test01.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
           ...
           % Set up Primary Object State and Covariance
            ...
            actSolution = FrisbeeMaxPc(r1_J2K*1000,v1_J2K*1000,C1_J2K,r2_J2K*1000,v2_J2K*1000,zeros(6,6),HBR); 
        ...
        function test14(testCase) % Previously Validated Case To Frisbee's Data (Case 1-1)
            ...
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-1.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test15(testCase) % Previously Validated Case To Frisbee's Data (Case 1-3)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-3.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test16(testCase) % Previously Validated Case To Frisbee's Data (Case 1-4)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-4.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test17(testCase) % Previously Validated Case To Frisbee's Data (Case 1-5)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-5.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test18(testCase) % Previously Validated Case To Frisbee's Data (Case 1-6)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-6.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test19(testCase) % Previously Validated Case To Frisbee's Data (Case 1-7)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-7.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test20(testCase) % Previously Validated Case To Frisbee's Data (Case 1-8)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-8.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test21(testCase) % Previously Validated Case To Frisbee's Data (Case 1-9)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-9.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test22(testCase) % Previously Validated Case To Frisbee's Data (Case 1-10)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-10.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test23(testCase) % Previously Validated Case To Frisbee's Data (Case 1-11)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-11.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test24(testCase) % Previously Validated Case To Frisbee's Data (Case 1-12)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-12.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test25(testCase) % Previously Validated Case To Frisbee's Data (Case 1-13)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-13.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test26(testCase) % Previously Validated Case To Frisbee's Data (Case 1-14)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-14.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
        ...
        function test27(testCase) % Previously Validated Case To Frisbee's Data (Case 1-15)
            ...
            HBRType                 = 'squareEquArea';
            % ID of Test Event
            FileName = '../../../DataFiles/SampleCDMs/SingleCovTestCase1-15.cdm';
            [cdmhead, cdmobj] = read_cdm(FileName);
...
% T. Lechtenberg | 03-19-2020 | Removed default parameters from
%                               FrisbeeMaxPc calls
