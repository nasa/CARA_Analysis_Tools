...
%                   quadrature points are being recalculated
%
% =========================================================================
%
% OUTPUT:
...
persistent sph_Lebedev deg_Lebedev pathsAdded
...
if isempty(params.Texpand)
    ...
    % accurate time integral.
    if ~isfield(params,'AccelerateRefinement'); params.AccelerateRefinement = []; end
    if isempty(params.AccelerateRefinement); params.AccelerateRefinement = false; end    
end
...
% D.Hall         | 2022-MAR-31 | Made Lebedev variables persistent,
%                                changing the way Lebedev_warning flag
%                                works
