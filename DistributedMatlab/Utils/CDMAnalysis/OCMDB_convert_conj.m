function conj = OCMDB_convert_conj(DB,params)
%==========================================================================
%
% Convert DB object to conj object (can be used to aid in writing test case
% CDMs)
%
...
if Ncol ~= 218
    error('Expecting 218 columns in OCMDB mat file.');
end
