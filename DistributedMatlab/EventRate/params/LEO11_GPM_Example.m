...
% for a prospective mission in an orbit like that of the GPM mission
...
params.mission_name = 'NewGPM';
params.mission_HBR_meters = 5;
params.mission_duration_years = 5;
params.mission_on_orbit_mass_kg = 1000; % Only used if exclude_noncatastrophic = true
