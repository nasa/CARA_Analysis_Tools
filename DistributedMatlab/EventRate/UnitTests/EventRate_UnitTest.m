...
classdef (SharedTestFixtures = {...
           ...
           matlab.unittest.fixtures.PathFixture('../src/ConjDist') ...
           matlab.unittest.fixtures.PathFixture('../src/matlab_lib') ...
           matlab.unittest.fixtures.PathFixture('../params') ...
           matlab.unittest.fixtures.PathFixture('../data') ...
           ...
           matlab.unittest.fixtures.PathFixture('../../Utils/Plotting/Utils') ...
