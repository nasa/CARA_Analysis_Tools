classdef Pc2D_Foster_UnitTest < matlab.unittest.TestCase
%% Series of Tests intended to test the 2D probability of Collision Calculation at TCA
    ...
    methods (Test)
        ...
        function test12(testCase) % Original Test Omitron Test Case 01 (Written by Dragan Plakalovic)
            ...
            Tol     = 1e-09;
            HBRType = 'circle';
            [actSolution]    = Pc2D_Foster(r1,v1,cov1,r2,v2,cov2,HBR,Tol,HBRType);
        ...
        function test15(testCase) % Non-PD test Case
            HBR             = 20;
            Accuracy        = 1E-10; 
            expSolution     = 0;
            % ID of Test Event
