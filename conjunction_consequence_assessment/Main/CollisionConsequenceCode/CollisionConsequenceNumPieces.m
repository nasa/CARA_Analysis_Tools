function [Catastrophic,NumOfPieces] = CollisionConsequenceNumPieces(PrimaryMass,VRel,SecondaryMass)
%
...
%
% May 2019; Last revision: 23-May-2019
%
% ----------------- BEGIN CODE -----------------
    ...
    NumOfPieces=round(0.1.*BigM.^0.75.*(0.05).^-1.71);
