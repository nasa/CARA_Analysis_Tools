...
% =========================================================================
%
%   This function uses Coppola's method to calculate the bounding times 
%   (tau0, tau1) for a linear conjunction event, given a state+covariance
%   at the nominal time of closest approach.
%
%   INPUT:
%
%       gamma   = The gamma value(s) for the calculation [NxM].
%                 (Note that gamma can be a matrix or vector of any size.)
%
%       HBR     = The combined-object hard-body radius (m or km) [1x1].
%
%       rci     = The inertial-frame relative position vector at the time
%                 of nominal closest approach for the conjunction
%                 (m or km) [3x1].
%
%       vci     = The inertial-frame relative velocity vector at the time
%                 of nominal closest approach for the conjunction
%                 (m/s or km/s) [3x1].

%       Pci     = The inertial-frame covariance matrix at the time
%                 of nominal closest approach (m & s or km & s)
%                 [3x3 or 6x6].
%
...
%
%       tau1_gam1 = Final   bounding time for gamma=1 (s) [1x1].
%
%       NOTES ON OUTPUT:
%
